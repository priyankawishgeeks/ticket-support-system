...
@section('content')
<div class="card">
    <div class="card-header bg-primary text-white">Add New Plan</div>
    <div class="card-body">
        <form action="{{ route('admin.plans.store') }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number" name="trial_days" class="form-control" value="{{ old('trial_days', 0) }}">
                </div>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number" name="max_storage_gb" class="form-control" value="{{ old('max_storage_gb') }}">
                </div>

                <div class="col-md-4 mb-3">
                    <label class="form-label">Max Projects</label>
                    <input type="number" name="max_projects" class="form-control" value="{{ old('max_projects') }}">
                </div>

                <div class="col-md-4 mb-3">
                    <label class="form-label">Border Color</label>
                    <input type="color" name="border_color" class="form-control form-control-color" value="{{ old('border_color', '#007bff') }}">
                </div>

                <div class="col-md-4 mb-3">
                    <label class="form-label">Title Color</label>
                    <input type="color" name="title_color" class="form-control form-control-color" value="{{ old('title_color', '#000000') }}">
                </div>

                <div class="col-md-4 mb-3">
                    <label class="form-label">Background Color</label>
                    <input type="color" name="background_color" class="form-control form-control-color" value="{{ old('background_color', '#f8f9fa') }}">
                </div>

                <div class="col-md-4 mb-3">
                    <label class="form-label">Badge Label</label>
                    <input type="text" name="badge_label" class="form-control" value="{{ old('badge_label') }}">
                </div>
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <textarea name="features" class="form-control" rows="3">{{ old('features') }}</textarea>
